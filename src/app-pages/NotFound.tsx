      ...
      <div className="text-center max-w-lg w-full">
        ...
        <div className="flex justify-center mb-6">
          <svg width="96" height="96" viewBox="0 0 96 96" fill="none" aria-hidden="true">
            <rect x="12" y="18" width="46" height="60" rx="4" fill="#fdf2f4" stroke="#6B1D2A" strokeWidth="2.5"/>
            <rect x="16" y="22" width="38" height="52" rx="2" fill="#fff"/>
            <line x1="22" y1="34" x2="48" y2="34" stroke="#6B1D2A" strokeWidth="2" strokeLinecap="round"/>
            ...
            <rect x="52" y="24" width="32" height="54" rx="4" fill="#6B1D2A" stroke="#6B1D2A" strokeWidth="2"/>
            ...
            <text x="58" y="70" fill="#fdf2f4" fontSize="10" fontWeight="700">?</text>
          </svg>
        </div>
