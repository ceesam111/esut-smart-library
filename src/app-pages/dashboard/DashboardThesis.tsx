      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="card bg-white rounded-lg shadow p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No Thesis Submitted Yet</h3>
            <p className="text-gray-600 mb-6">
              Once you submit your thesis, you can track its progress through each stage of the review process.
            </p>
            <div className="flex gap-3 justify-center flex-wrap">
              <a href="/thesis/submit" className="btn-primary px-6 py-2 rounded font-semibold">Submit Thesis</a>
              <a href="/dashboard" className="btn-outline px-6 py-2 rounded font-semibold">Back to Dashboard</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="card bg-white rounded-lg shadow p-8 mb-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              {thesis.degree_programme} — Submitted {new Date(thesis.submission_date).toLocaleDateString()}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-8 pb-8 border-b border-gray-200">
            ...
            <div className="bg-purple-50 rounded-lg p-4">
              <div className="text-sm text-gray-600 font-medium mb-1">Current Status</div>
              <div className="text-lg font-semibold text-gray-900">{thesis.status}</div>
            </div>
          </div>

          <div className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-6">Review Progress</h2>
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-600 mt-2">Stage {thesis.current_stage} of 4</p>
            </div>
          ...
          {thesis.supervisor_comments && (
            <div className="bg-yellow-50 border-2 border-yellow-200 rounded-lg p-6">
              ...
              <p className="text-gray-700 leading-relaxed">{thesis.supervisor_comments}</p>
            </div>
          )}
        </div>
        ...
        <div className="card bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-3">
            <a href={`/thesis/${thesis.id}/view`} className="btn-outline block text-center px-4 py-2 rounded font-semibold">
              View Submission
            </a>
            <a href={`/thesis/${thesis.id}/edit`} className="btn-ghost block text-center px-4 py-2 rounded font-semibold">
              Update Metadata
            </a>
            {thesis.status === 'Library Published' && (
              <a href={`/thesis/${thesis.id}/publish`} className="btn-primary block text-center px-4 py-2 rounded font-semibold">
                View Published
              </a>
            )}
          </div>
          ...
          <div className="space-y-3 text-sm text-gray-700">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <div className="text-gray-600">{new Date(thesis.submission_date).toLocaleDateString()}</div>
              </div>
            </div>
            {thesis.current_stage >= 2 && (
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <div className="text-gray-600">Your supervisor is reviewing your thesis</div>
                </div>
              </div>
            )}
            {thesis.current_stage >= 3 && (
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <div className="text-gray-600">Undergoing committee evaluation</div>
                </div>
              </div>
            )}
            {thesis.current_stage >= 4 && (
              <div className="flex gap-3">
                <span className="text-2xl">📚</span>
                <div>
                  <div className="font-semibold">Published in Digital Library</div>
                  <div className="text-gray-600">Your thesis is now publicly available</div>
                </div>
              </div>
            )}
          </div>
