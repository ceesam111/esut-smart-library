...
interface ILLTicket {
  ...
  status: 'Requested' | 'Approved' | 'In Transit' | 'Ready' | 'Collected' | 'Returned';
  request_date: string;
                ...
                <tbody className="divide-y divide-gray-200">
                  {tickets.map((ticket) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-sm text-gray-600">
                        {ticket.pickup_date
                          ? new Date(ticket.pickup_date).toLocaleDateString()
                          : '—'}
                      </td>
                      <td className="px-6 py-4">
